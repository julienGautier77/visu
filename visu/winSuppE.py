...
class WINENCERCLED(QWidget):
    ...
    def __init__(self,nbcam):
        ...
        self.nbcam=nbcam
        self.confCCD = QtCore.QSettings('conf.ini', QtCore.QSettings.IniFormat)
    ...
    def setup(self):
        ...
        #self.p1.setLimits(xMin=0)#, xMax=self.data.shape[0])# yMin=0, yMax=self.data.shape[1]) permet de remplir toute la largeur de P1
