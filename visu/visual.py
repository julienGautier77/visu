...
class SEE(QMainWindow):
    ...
    def Display(self, data):
        ...
        #  autosave
        if self.checkBoxAutoSave.isChecked() is True:  # autosave data
            ...
            # else:
            num = str(self.numTir)
            if self.winOpt.checkBoxDate.isChecked() is True:  # add the date
    ...
    def HIST(self):
        ...
        '''
        if self.checkBoxHist.isChecked() is False:
