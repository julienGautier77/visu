...
from winSuppE import WINENCERCLED
from WinCut import GRAPHCUT
from winMeas import MEAS
from WinOption import OPTION
import pylab
...
class SEE(QWidget) :
    ...
    def __init__(self,file=None,path=None):
        ...
        self.conf = QtCore.QSettings('confVisu.ini', QtCore.QSettings.IniFormat)
    ...
    def setup(self):
        ...
        self.setStyleSheet("QCheckBox::indicator{width: 30px;height: 30px;}""QCheckBox::indicator:unchecked { image : url(./icons/Toggle Off-595b40b85ba036ed117dac78.svg);}""QCheckBox::indicator:checked { image:  url(./icons/Toggle On-595b40b85ba036ed117dac79.svg);}""QCheckBox{font :10pt;}")
        
        vbox1=QVBoxLayout() 
        
        hbox2=QHBoxLayout()
        self.openButton=QPushButton('Open',self)
        self.openButton.setIcon(QtGui.QIcon("./icons/Open.svg"))
        ...
        self.saveButton.setIcon(QtGui.QIcon("./icons/Saving.svg"))
        ...
        self.optionAutoSave.setIcon(QtGui.QIcon("./icons/Settings.svg"))
        ...
        self.ligneButton.setIcon(QtGui.QIcon("./icons/ligne.jpeg")) 

        hbox10.addWidget(self.ligneButton)
        
        self.rectangleButton=QPushButton('Rect')
        self.rectangleButton.setIcon(QtGui.QIcon("./icons/rectangle.png")) 
        hbox10.addWidget(self.rectangleButton)
        
        self.circleButton=QPushButton('Circle')
        self.circleButton.setIcon(QtGui.QIcon("./icons/Red_circle.png")) 
